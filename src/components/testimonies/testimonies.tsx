...
const Testimonies = ({
  ...
  return (
    <Stack
      ...
      gap={4}
    >
      <Typography fontWeight={"bold"} color={colors.secondary}>
        TESTIMONIALS
      </Typography>
      ...
      >
        <Testimony
          message="Takcooling provided fast and professional service when our air conditioner broke down. Within hours, they had it up and running again."
          title="Business man"
        ...
        />
        <Testimony
          message="Takcooling's customer support is excellent. They're always available to answer questions and provide solutions. Really Great company!"
          title="House keeper"
