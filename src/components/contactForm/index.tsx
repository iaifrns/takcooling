  ...
  return (
    ...
    >
      <Stack
        ...
        gap={5}
      >
        <Typography variant="h4" display={match ? 'none' : 'block'}>Contact Us</Typography>
        <Stack direction={ match ? 'column' : "row"} gap={ match ? 4 : 1} width={"100%"}>
      ...
      <Stack display={match ? 'none' : 'flex'} direction={"column"} width={"40%"}>
        <img
